<template>
  <div>
    ...
    <!-- Connection Status -->
    <div v-if="connectionStatus" class="mb-4 p-3 bg-indigo-50 border-l-4 border-indigo-500 text-indigo-700 text-sm rounded shadow-sm">
      <p>{{ connectionStatus }}</p>
    </div>

    <div class="grid md:grid-cols-2 gap-6">
      <!-- Left Column: Input Form -->
      <div class="bg-white rounded-lg shadow-md p-5 border-t-4 border-indigo-500 hover:shadow-lg transition-shadow">
        ...
        <div v-if="activeTab === 'image'" class="mb-4">
          <div class="flex items-center justify-center w-full">
            <label
              class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-slate-300 rounded-lg cursor-pointer bg-slate-50 hover:bg-indigo-50 transition-colors"
            >
      ...
      <div class="grid grid-cols-1 gap-5">
        <div class="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-lg shadow-md p-5 hover:shadow-lg transition-shadow">
          <div class="flex items-start">
            ...
            <div>
              <h2 class="text-base font-semibold mb-2 text-indigo-900">Step-by-Step Solutions</h2>
              <p class="text-slate-700">Our AI breaks down every geometry problem into clear, understandable steps.</p>
            </div>
          </div>
        </div>
        
        <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg shadow-md p-5 hover:shadow-lg transition-shadow">
          <div class="flex items-start">
            <div class="bg-white p-3 rounded-lg mr-4 shadow-sm">
            ...
            <div>
              <h2 class="text-base font-semibold mb-2 text-purple-900">Image Recognition</h2>
              <p class="text-slate-700">Upload a photo of your geometry problem, and our AI will interpret and solve it.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg p-4 border border-slate-200 shadow-sm">
        ...
        <div class="flex flex-wrap gap-2">
          <button 
            ...
            class="px-3 py-2 bg-slate-50 rounded border border-slate-200 text-slate-700 hover:bg-indigo-50 hover:border-indigo-200 transition-colors"
          >
            Triangle Area
          </button>
          <button 
